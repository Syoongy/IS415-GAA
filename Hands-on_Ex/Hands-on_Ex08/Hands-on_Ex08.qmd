---
title: "Hands-on Exercise 8: Regression Modelling of Geographically Reference Data"
...
We first read in the geospatial data

```{r}
mpsz = st_read(dsn = "data/geospatial", layer = "MP14_SUBZONE_WEB_PL")
```

Now the aspatial data
...
We first want to ensure that our shapefile is in the correct ESPG code (3414)
...
Let's now take a glimpse at our aspatial data
